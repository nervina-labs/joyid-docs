...
After the user signed with JoyID App, the user will be redirected back to your App with the result in the URL query string. We need to call `signCallbck` function in your redirected page to get the result.
...
::code-group
  ...
  ::code-block{label="Vue" Vue}
    :sandbox{src="https://stackblitz.com/edit/react-joyid-sign-with-redirect?embed=1&file=App.vue&view=preview"}
  ::
::
