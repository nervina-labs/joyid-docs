...
<ClickToActivate>
  <FrameworkTabs>
    <FrameworkTabs.React>
      <iframe className="sandbox" src="https://stackblitz.com/edit/react-joyid-ckb-sign-nft-tx?embed=1&file=App.tsx&view=preview" />
    </FrameworkTabs.React>
    <FrameworkTabs.Vue>
      <iframe className="sandbox" src="https://stackblitz.com/edit/vue-joyid-ckb-sign-nft-tx?embed=1&file=App.vue&view=preview" />
    </FrameworkTabs.Vue>
  </FrameworkTabs>
</ClickToActivate>
