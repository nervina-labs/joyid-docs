...
Once the NFTs are claimed to your JoyID account, you can visit NFT list in [JoyID App](https://testnet.joyid.dev/?asset=Collectible). You can click any NFT to visit NFT detail page and the page URL is like this:
...
<FrameworkTabs>
  <FrameworkTabs.React>
    <iframe  width="800" height="800" src="https://stackblitz.com/edit/react-joyid-ckb-sign-nft-tx?embed=1&file=App.tsx&view=preview" ></iframe>
  </FrameworkTabs.React>
  <FrameworkTabs.Vue>
    <iframe  width="800" height="800" src="https://stackblitz.com/edit/vue-joyid-ckb-sign-nft-tx?embed=1&file=App.vue&view=preview" ></iframe>
  </FrameworkTabs.Vue>
</FrameworkTabs>
